"""memento provider implementations for the benchmark.

These implement ``MemoryProvider`` using memento's EtchStore/EtchRetriever.
Use them to benchmark memento against any other MemoryProvider.
"""
...
class EtchBenchmarkProvider(MemoryProvider):
    """memento benchmark provider using FTS5 + HRR + search_expanded.
    ...
    name = "etch"
    description = "memento: SQLite FTS5 + HRR persistent memory"
    kind = "local"
