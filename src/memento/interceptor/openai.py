"""OpenAI ChatCompletion interceptor — captured as memento facts.
...
if TYPE_CHECKING:
    ...
    from memento.interceptor import InterceptorHandle
    ...
    def _wrapper(*args: Any, **kwargs: Any) -> Any:
        ...
        if kwargs.get("stream", False):
            raise NotImplementedError(
                "Streaming is not supported in memento interceptor v1. "
